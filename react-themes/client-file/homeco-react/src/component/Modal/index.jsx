...
function InvoiceView({ isOpen, handleModal, invoice }) {
  const {
    name,
    number,
    email,
        ...
        <div className="modal-content">
          ...
          <div className="homec-modal__inner">
            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-md-6 col-12">
                <ul className="homec-modal__list homec-modal__list--v2 list-none">
                  <li>
                  ...
                  <li>
                    <span>Payment:</span> {paymentMethod}
                  </li>
                  <li>
            ...
            <div className="homec-invoices  homec-invoice-table--v2 mg-top-30">
              <table className="homec-invoice-table m-0">
                <thead className="homec-invoice-table__head">
                  <tr>
                    <th className="homec-invoice-table__column1">Packages</th>
                    <th className="homec-invoice-table__column2">
                      Purchase Date
                    </th>
                    <th className="homec-invoice-table__column3">
                      Expired Date
                    </th>
                    <th className="homec-invoice-table__column4">Amount</th>
                    <th className="homec-invoice-table__column5">Invoice</th>
                  </tr>
                </thead>
                <tbody className="homec-invoice-table__body">
                  <tr>
                    ...
                    <td className="homec-invoice-table__column2">
                      <p className="homec-invoice-table__text">
                        {purchaseDate}
                      </p>
                    </td>
                    ...
                    <td className="homec-invoice-table__column5">
                      <button className="homec-invoice-table--btn">
                        Download
                      </button>
                    </td>
                  </tr>
