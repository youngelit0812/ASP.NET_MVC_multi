						...
						<div className="header-menu d-none d-xl-block go-top">
							...
							<div className="ltn__main-menu">
								...
								<li className="menu-icon"><Link to="#">Home</Link>
									...
									<li>
																<Link to="/">Home Style 01<span className="menu-item-badge">video</span></Link>
									...
									<li>
																<Link to="/home-v5">Home Style 05</Link>
									...
									<li>
										...
										<img src={publicUrl+"assets/img/home-demos/home-10.jpg"}  alt="#" />
									</li>
