...
namespace MultiFamilyPortal.SaaS.Authentication.MicrosoftAccount
{
    ...
    public class MicrosoftAccountHandler : OAuthHandler<MicrosoftAccountOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public MicrosoftAccountHandler(ITenantSettingsContext context, IOptionsMonitor<MicrosoftAccountOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock)
            : base(context, options, logger, encoder, clock)
        { }

        protected override string ClientIdKey => PortalSetting.MicrosoftClientId;

        protected override string ClientSecretKey => PortalSetting.MicrosoftClientSecret;
